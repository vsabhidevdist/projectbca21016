...
$dao=new DataAccess();
$elements=array(
        "name"=>"","gender"=>"","age"=>"","email"=>"","phone"=>"","password"=>"");


$form=new FormAssist($elements,$_POST);
//$file=new FileUpload();
$labels=array('name'=>"User Name","gender"=>"User Gender","age"=>"Age","email"=>"Email",,"phone"=>"Phone","password"=>"Password","cpassword"=>"Confirm Password");

$rules=array(
    "name"=>array("required"=>true,"minlength"=>3,"maxlength"=>30,"alphaspaceonly"=>true),
    "address"=>array("required"=>true,"minlength"=>3,"maxlength"=>50),
    "email"=>array("required"=>true,"email"=>true,"unique"=>array("field"=>"email","table"=>"user")),
     "contact"=>array("required"=>true,"integeronly"=>true,"minlength"=>1,"maxlength"=>13),
    "username"=>array("required"=>true,"minlength"=>7,"maxlength"=>10),
                ...
                <div class="card-body">
					...
					<p><?php if(isset($msg)) echo $msg; ?></p>
                        <div class="input-group">
                         ...
                         <div class="input-group">
                             <?= $form->textBox('address',array("placeholder"=>"Adderss")); ?>
                         ...
                         <div class="input-group">
                             <?= $form->textBox('phone',array("placeholder"=>"Phone")); ?>
